...
render() {
    ...
    return (
        ...
        <div className="row justify-content-center">
            <div className="col-8">
                <h2 className="font-weight-light text-center">Registrera ett ärende.</h2>
                ...
                <form className="mt-4" onSubmit={this.onSubmit}>
                    ...
                    <div className="form-row">
                        <div className={"form-group col-md-6" + (submitted && !company ? " has-error" : "")}>
                            ...
                            {submitted && !company &&
                                <div className="invalid-feedback">Du måste fylla i företagsnamn</div>
                            }
                        </div>
                    ...
                    <div className="form-row">
                        <div className={"form-group col-md-6" + (submitted && !email ? " has-error" : "")}>
                            ...
                            {submitted && !email &&
                                <div className="invalid-feedback">Du måste fylla i e-mail</div>
                            }
                        </div>
                        <div className={"form-group col-md-6" + (submitted && !phone ? " has-error" : "")}>
                            <label htmlFor="phone">Telefonnummer</label>
                            <input type="text" className={"form-control" + (submitted && !phone ? " is-invalid" : "")} id="phone" placeholder="XXXXXXXXXX" value={phone} onChange={this.handleChange} />
                            {submitted && !phone &&
                                <div className="invalid-feedback">Du måste fylla i telefonnummer</div>
                            }
                    ...
                    <div className={"form-group" + (submitted && !case_title ? " has-error" : "")}>
                        ...
                        <input type="text" className={"form-control" + (submitted && !case_title ? " is-invalid" : "")} id="case_title" placeholder="Rubrik här..." value={case_title} onChange={this.handleChange} />
                        {submitted && !case_title &&
                            <div className="invalid-feedback">Skriv en rubrik som beskriver ärendet</div>
                        }
                    </div>
                    <div className={"form-group" + (submitted && !case_description ? " has-error" : "")}>
                        <label htmlFor="case_description">Ärende</label>
                        <textarea rows="6" type="text" className={"form-control" + (submitted && !case_description ? " is-invalid" : "")} id="case_description" placeholder="beskrivning..." value={case_description} onChange={this.handleChange} />
                        {submitted && !case_description &&
                            <div className="invalid-feedback">Beskriv ärendet </div>
                        }
                    </div>
